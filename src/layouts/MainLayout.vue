  ...
  <q-layout view="lHh Lpr lFf">
    <q-header>
      ...
      <div class="q-px-lg q-pt-xs q-mb-md">
        <div class="text-h3">Séneca App</div>
        <div class="text-subtitle1">{{ fechaActual }}</div>
      </div>
    ...
    >
      ...
      >
        <q-list padding>
          ...
          <q-item clickable v-ripple to="/cartas">
            <q-item-section avatar>
              <q-icon name="phone" />
            </q-item-section>

            <q-item-section> C. Llamadas </q-item-section>
          </q-item>

          <q-item active clickable v-ripple to="/expedientes">
            <q-item-section avatar>
              <q-icon name="folder" />
            </q-item-section>
      ...
      >
        <div class="absolute-bottom bg-transparent">
          ...
          <div class="text-weight-bold">J.Cardona</div>
          <div>@jcardona</div>
        </div>
      </q-img>
    </q-drawer>
